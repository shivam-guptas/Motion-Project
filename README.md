...
A browser-only animated graphics engine for kids age 2-5. It renders calming cartoon scenes in Canvas 2D with friendly characters, soft particles, and rotating themes.
...
- There are 23 rotating scenes total: Underwater, Space, Candyland, plus 20 extra colorful scene variants.
